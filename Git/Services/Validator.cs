namespace Git.Services
{
    ...
    public class Validator : IValidator
    {
        ...
        public ICollection<string> ValidateRepository(CreateRepositoryFormModel model)
        {
            ...
            if (model.Name.Length < RepositoryMinName || model.Name.Length > RepositoryMaxLenght)
            {
                errors.Add($"Repository '{model.Name}' is not valid. It must be between {RepositoryMinName} and {RepositoryMaxLenght} characters long.");
            }
